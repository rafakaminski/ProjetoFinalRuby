...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { cod: @occurrence.cod, description: @occurrence.description, title: @occurrence.title } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { cod: @occurrence.cod, description: @occurrence.description, title: @occurrence.title } }
